...
//**************************************************
    ...
    init(task: URLSessionTask) {
        self.delegate = RequestDelegate(task: task)
    ...
    init(task: URLSessionTask, uploadProgressClosure: @escaping (_ error: String, _ progressStatus: String) -> Void ) {
        ...
        self.delegate = RequestDelegate(task: task, uploadProgressClosure: self.uploadProgressClosure)
