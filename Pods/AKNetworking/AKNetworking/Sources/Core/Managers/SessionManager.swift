...
public class SessionManager {
    ...
    internal var error: NSError? { return delegate?.error }
    ...
    private func configuration() {
        ...
        self.delegate = SessionManagerDelegate()
        ...
        self.localSession = URLSession(configuration: configuration, delegate: self.delegate, delegateQueue: nil)
        self.uploadProgressClosure = {_, _ in }
    ...
    func uploadRequest(urlRequest: NSURLRequest) -> Request? {
        ...
        // store the task
        self.delegate?[task] = request.delegate
