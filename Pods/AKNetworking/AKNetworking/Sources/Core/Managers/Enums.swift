...
public enum ParameterEncoding {
     ...
     */
    public func encodeRequest(_ urlRequest: URLRequest, parameters: [String: AnyObject]?) -> URLRequest {
        if parameters == nil {
            return urlRequest
        }
        ...
        if let mutableURLRequest = (urlRequest as NSURLRequest).mutableCopy() as? NSMutableURLRequest {
            ...
            case .multipart:
                return encodeMultipartRequest(mutableURLRequest, parameters)
    ...
    private func encodeMultipartRequest(_ urlRequest: NSMutableURLRequest, _ parameters: [String: AnyObject]?) -> URLRequest {
        let boundary = "----ABCD"
